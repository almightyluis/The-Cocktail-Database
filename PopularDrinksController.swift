...
class PopularDrinksController: UIViewController {
    ...
    fileprivate var popularLink = "https://www.thecocktaildb.com/api/json/v2/9973533/popular.php";
    ...
    fileprivate func createApiCall()->Void {
        ...
        let api = APICall();
        var counter:Int32 = 1;
        api.generalSearch(link: popularLink) { drinkArray in
    ...
    fileprivate func setTopContainer()->Void {
        ...
        upperLabel.text = "List of popular cocktails.";
